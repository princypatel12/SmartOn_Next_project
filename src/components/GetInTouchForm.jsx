...
export default function GetInTouchForm({title,highlightText}){
  ...
  const handleSubmit = (e) => {
    ...
    return(
        <section id="down-section" className="py-12 px-4 max-w-3xl mx-auto">
        ...
        <div className="w-full flex justify-center">
            <div className="w-full max-w-3xl">
                <form action=""  onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <textarea classname="form-textarea border border-sm rounded p-3 md:col-span-2" rows="4" name="comment" placeholder="Your message" value={formData.comment} onChange={handleChange}/>
                    <div className="md:col-span-1 text-sm text-[16px] rubik-font">
          ...
          <div className="md:col-span-1 text-center md:text-right">
            <button
              type="submit"
              className="px-6 py-3 rounded bg-[#ED5428] text-white font-semibold shadow-md hover:shadow-lg transition"
            >
              Send message
            </button>
          </div>
